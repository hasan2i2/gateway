...
class GatewayServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        //php artisan vendor:publish --provider=hugenet\Gateway\GatewayServiceProvider --tag=config
        $this->publishes([
            $config => config_path('gateway.php'),
        ], 'config');

        // php artisan vendor:publish --provider=hugenet\Gateway\GatewayServiceProvider --tag=migrations
        $this->publishes([
        ...
        // php artisan vendor:publish --provider=hugenet\Gateway\GatewayServiceProvider --tag=views
        $this->publishes([
